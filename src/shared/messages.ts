...
const en: Table = {
  ...
  'BAD_USER_INPUT.CHECK_IN_LIMIT': 'You have reached today’s limit of {max} check-ins.',
  ...
  'BAD_USER_INPUT.PERIOD_OVERLAP': 'That day is already part of a logged period.',
  'BAD_USER_INPUT.BEFORE_LATEST': 'That day is before your latest logged period.',
  'BAD_USER_INPUT.NO_PERIOD': 'There is no period in progress.',
  'BAD_USER_INPUT.END_BEFORE_START': 'A period cannot end before it starts.',
...
const fr: Table = {
  ...
  'BAD_USER_INPUT.CHECK_IN_LIMIT': 'Vous avez atteint la limite de {max} bilans pour aujourd’hui.',
  ...
  'BAD_USER_INPUT.PERIOD_OVERLAP': 'Ce jour fait déjà partie de règles enregistrées.',
  'BAD_USER_INPUT.BEFORE_LATEST': 'Ce jour est avant vos dernières règles enregistrées.',
  'BAD_USER_INPUT.NO_PERIOD': 'Aucunes règles ne sont en cours.',
  'BAD_USER_INPUT.END_BEFORE_START': 'Les règles ne peuvent pas finir avant d’avoir commencé.',
...
const sw: Table = {
  ...
  'BAD_USER_INPUT.CHECK_IN_LIMIT': 'Umefikia kikomo cha leo cha kuandika hali mara {max}.',
  ...
  'BAD_USER_INPUT.PERIOD_OVERLAP': 'Siku hiyo tayari ni sehemu ya hedhi iliyoandikwa.',
  'BAD_USER_INPUT.BEFORE_LATEST': 'Siku hiyo ni kabla ya hedhi yako ya mwisho iliyoandikwa.',
  'BAD_USER_INPUT.NO_PERIOD': 'Hakuna hedhi inayoendelea.',
  'BAD_USER_INPUT.END_BEFORE_START': 'Hedhi haiwezi kuisha kabla ya kuanza.',
...
const rn: Table = {
  ...
  'BAD_USER_INPUT.CHECK_IN_LIMIT':
    'Washitse ku rugero rw’uyu munsi rw’incuro {max} zo kwandika uko umerewe.',
  ...
  'BAD_USER_INPUT.PERIOD_OVERLAP': 'Uwo munsi usanzwe uri mu mihango yanditswe.',
  'BAD_USER_INPUT.BEFORE_LATEST': 'Uwo munsi uri imbere y’imihango yawe iheruka kwandikwa.',
  'BAD_USER_INPUT.NO_PERIOD': 'Nta mihango iriko iraba.',
  'BAD_USER_INPUT.END_BEFORE_START': 'Imihango ntishobora guhera itaratangura.',
